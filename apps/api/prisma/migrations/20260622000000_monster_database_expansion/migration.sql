...
CREATE TABLE "monster_rise_data" (
    ...
    "breakRewards" JSONB,
    CONSTRAINT "monster_rise_data_monsterId_fkey" FOREIGN KEY ("monsterId") REFERENCES "game_monsters" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "monster_wilds_data" (
    ...
    CONSTRAINT "monster_wilds_data_monsterId_fkey" FOREIGN KEY ("monsterId") REFERENCES "game_monsters" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "monster_db_materials" (
    ...
    CONSTRAINT "monster_db_materials_monsterId_fkey" FOREIGN KEY ("monsterId") REFERENCES "game_monsters" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "monster_images" (
    ...
    "sortOrder" INTEGER NOT NULL DEFAULT 0,
    CONSTRAINT "monster_images_monsterId_fkey" FOREIGN KEY ("monsterId") REFERENCES "game_monsters" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
